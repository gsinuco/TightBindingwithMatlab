...
%******************************************* 
N       = 129;       % Number of Wells, must be odd
s       = 12;         % Lattice Depth in Er
a       = 4.0*a0;      % Scattering length
omgLong = 2*pi * 50;  % Longitudinal trap frequency
omgPerp = 2*pi * 600; % radial, perpendicular trap freq.
...
K     = 0.0;                % Argument of the Bessel function 

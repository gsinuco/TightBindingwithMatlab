function [time_Spam,q,psi_q_2_vect,Atoms_Edge] = EffectiveTightBinding_FiniteTemp_TimeEvolution_V2(index_)
% figure(3)
% subplot(2,1,1)
...
periodLong = 120e-3/index_;              % Trap period in seconds
...
rng('default');
phase_factor = exp(0.00001*1i*2.0*pi*rand(N,1));
